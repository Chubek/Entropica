...
def format_magic_range(rng: list[int], split=8, prefix="unsigned short UDIV_MAGICS[UDIVMAGIC_SIZE] = {", suffix="};", pad="08x", indent="\t") -> list[int]:
...
if __name__ == "__main__":
    ...
    for arg in argv:
        ...
        prefix = parse_or_default(arg, ["--prefix", "-pr"], 'entropica_udivmagics_t UDIV_MAGICS = {', str)
    ...
    pretext = f'// udivmagics generated by {argv[0]} ~ timestamp={time()}s\n'
